# Contributing to toolbox / 贡献指南

First off, thank you for considering contributing to `toolbox`! It's people like you who make the open-source community such an amazing place to learn, inspire, and create.

首先，非常感谢你愿意为 `toolbox` 贡献力量！正是因为有你的参与，开源社区才会变得更好。
...
`toolbox` is a hybrid project with a Go backend and a React/TypeScript frontend. 
`toolbox` 是一个由 Go 后端和 React/TypeScript 前端构成的混合项目。
...
git clone https://github.com/yann0917/toolbox.git
cd toolbox
